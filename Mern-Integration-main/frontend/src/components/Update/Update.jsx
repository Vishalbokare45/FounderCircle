...
const Update = () => {
    ...
    const [profile, setprofile] = useState({ name: "", userimage: "" });
        ...
        <>
            ...
            <div className="cotainer mx-auto px-4 py-8 mt-20">
                <div className='text-right'>
                    ...
                    <Link
                        onClick={openModal}
                        className="mx-2 py-2 px-3 text-gray-700rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#5F9EA0] md:p-0"
