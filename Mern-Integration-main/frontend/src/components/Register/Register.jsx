...
const Register = () => {
  ...
  <form className="space-y-4" onSubmit={handleSubmit}>
    ...
    <div>
      ...
      <input
        type="text"
        className="bg-gray-100 border border-gray-300 text-gray-800 text-sm rounded-lg focus:ring-[#5F9EA0] focus:border-[#5F9EA0] block w-full p-2.5"
        name="userName"
    ...
    <div className=" font-medium text-center text-gray-500">
      Already registered?{' '}
      <Link to="/login" className="text-[#5F9EA0] hover:underline">
        Login here
      </Link>
    </div>
  </form>
